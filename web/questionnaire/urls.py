...
urlpatterns = [
    ...
    path("schoolclass/add/student", views.AddSchoolClassToStudent.as_view(),
            name="add_school_class_to_student"),
    ...
    path('questionnaireconclusion/list/<questionnaire_pk>', views.QuestionnaireConclusionList.as_view(),
         name="questionnaireconclusion_list"),
    path('quizrersult/list/<questionnaire_pk>/<student_pk>', views.QuizResultList.as_view(),
         name="quizresult_list")
]
