# Generated by Django 2.2.12 on 2020-04-02 22:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quizzes', models.ManyToManyField(blank=True, to='questionnaire.Quiz', verbose_name='Questões')),
                ('school_classes', models.ManyToManyField(to='questionnaire.SchoolClass', verbose_name='Turmas')),
            ],
            options={
